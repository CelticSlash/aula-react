...
export default function LoginPage() {
    const [username, setUsername] = React.useState("dawne_jonson");
        ...
        <Layout title="Login">
            <div className="row" style={{marginTop: '150px'}}>
                <div className='col-6 d-none d-lg-block text-end'>
                    <img src="/img/capa.png" style={{minHeight : '480px'}} />
                </div>
                <div className='col-lg-4 col-10 mx-auto mx-lg-0'>
                    <div className='border rounded-1 p-5 my-2 mx-auto mx-lg-0' style={{ maxWidth: '430px', minWidth: '430px' }} >
                        <h2 className='mb-5 fw-bold' style={{ 'fontSize': '50px', 'fontFamily': "'Cookie', cursive" }}>Predagram</h2>
